 ...
 */
package vip.xiaonuo.main.modular.tbworkerorderspeed.enums;
...
public enum TbWorkerorderSpeedExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        TbWorkerorderSpeedExceptionEnum(Integer code, String message) {
        this.code = code;
