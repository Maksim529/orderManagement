 ...
 */
package vip.xiaonuo.main.modular.tbcontract.enums;
...
public enum TbContractExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        TbContractExceptionEnum(Integer code, String message) {
        this.code = code;
