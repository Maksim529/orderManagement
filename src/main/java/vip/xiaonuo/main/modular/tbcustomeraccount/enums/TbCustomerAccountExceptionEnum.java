...
package vip.xiaonuo.main.modular.tbcustomeraccount.enums;
...
public enum TbCustomerAccountExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        TbCustomerAccountExceptionEnum(Integer code, String message) {
        this.code = code;
