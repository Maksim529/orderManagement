 ...
 */
package vip.xiaonuo.main.modular.tbworkerorderexception.mapper;
 ...
 *
 * @author maksim
 * @date 2022-01-12 09:58:20
 */
public interface TbWorkerOrderExceptionMapper extends BaseMapper<TbWorkerOrderException> {

    Page<TbWorkerOrderException> findPage(@Param("page") Page page, @Param("ew") QueryWrapper queryWrapper);
