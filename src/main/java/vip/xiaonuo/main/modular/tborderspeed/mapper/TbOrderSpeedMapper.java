 ...
 */
package vip.xiaonuo.main.modular.tborderspeed.mapper;
 ...
 */
public interface TbOrderSpeedMapper extends BaseMapper<TbOrderSpeed> {
    Page<TbOrderSpeed> findPage(@Param("page") Page page, @Param("ew") QueryWrapper queryWrapper);
}
