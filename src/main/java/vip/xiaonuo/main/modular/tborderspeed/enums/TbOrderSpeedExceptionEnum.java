 ...
 */
package vip.xiaonuo.main.modular.tborderspeed.enums;
...
public enum TbOrderSpeedExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        TbOrderSpeedExceptionEnum(Integer code, String message) {
        this.code = code;
