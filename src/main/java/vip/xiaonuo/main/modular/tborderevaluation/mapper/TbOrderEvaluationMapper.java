 ...
 */
package vip.xiaonuo.main.modular.tborderevaluation.mapper;
 ...
 */
public interface TbOrderEvaluationMapper extends BaseMapper<TbOrderEvaluation> {
    Page<TbOrderEvaluation> findPage(@Param("page") Page page, @Param("ew") QueryWrapper queryWrapper);
}
