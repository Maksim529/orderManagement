 ...
 */
package vip.xiaonuo.main.modular.tborderevaluation.enums;
...
public enum TbOrderEvaluationExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        TbOrderEvaluationExceptionEnum(Integer code, String message) {
        this.code = code;
