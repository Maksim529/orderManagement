...
public enum TbWorkerorderReportedDetailExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        TbWorkerorderReportedDetailExceptionEnum(Integer code, String message) {
        this.code = code;
