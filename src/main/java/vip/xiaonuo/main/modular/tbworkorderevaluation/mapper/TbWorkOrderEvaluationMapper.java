 ...
 */
package vip.xiaonuo.main.modular.tbworkorderevaluation.mapper;
 ...
 */
public interface TbWorkOrderEvaluationMapper extends BaseMapper<TbWorkOrderEvaluation> {
    Page<TbWorkOrderEvaluation> findPage(@Param("page") Page page, @Param("ew") QueryWrapper queryWrapper);
}
