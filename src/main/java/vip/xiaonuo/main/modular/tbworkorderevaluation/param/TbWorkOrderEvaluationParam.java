 ...
 */
package vip.xiaonuo.main.modular.tbworkorderevaluation.param;
...
*/
@Data
public class TbWorkOrderEvaluationParam extends BaseParam {
     ...
     * 订单id
     */
    @NotNull(message = "订单id不能为空，请检查workerOrderId参数", groups = {add.class, edit.class})
