 ...
 */
package vip.xiaonuo.main.modular.tbworkorderevaluation.enums;
...
public enum TbWorkOrderEvaluationExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        TbWorkOrderEvaluationExceptionEnum(Integer code, String message) {
        this.code = code;
